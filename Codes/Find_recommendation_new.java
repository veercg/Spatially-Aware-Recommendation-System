	...
	public static void main(String args[])
	{
		...
		try
		{
			...
			// Making two array of movie's ids which are higly rated by active user and rest of users respectively.. 
				...
				ArrayList al1 = new ArrayList(60);
			...
			/*	System.out.println("ACTIVE USER FAV MOVIES");
				for(int i=0; i<active_fav_movie_arr.length; i++) 
				{
					System.out.print(active_fav_movie_arr[i]+" | "); 
				} */
			//	System.out.println(" ");
			/*	System.out.println("REST USER FAV MOVIES");
				for(int i=0; i<rest_fav_movie_arr.length; i++) 
				{
					System.out.print(rest_fav_movie_arr[i]+" | "); 
				}*/
				...
				in0.close();
				System.out.println("NO. OF HIGHLY RATED MOVIES FALLING IN DIFFERENT CATEGORIES : ");
					...
					/*if(rest_mov_catg[i][catg_max1_index]==1 && rest_mov_catg[i][catg_max2_index]==1)
						{
							...
							if(chk_in_array(active_all_movie_arr,rest_fav_movie_arr[i])==1)
							{
								...
								System.out.println(active_all_rating_arr[index]+" "+rest_fav_movie_arr[i]+" "+find_movie_details(rest_fav_movie_arr[i]));
				...
				/*	if(rest_mov_catg[i][catg_max1_index]==1 || rest_mov_catg[i][catg_max2_index]==1)
					...
					float avg_rat = (float)rat_sum/(float)recc_count;
					System.out.println("AVERAGE RATING = "+avg_rat);
			}
			else
			{
